...
<body onload="generateProducts(), loadModal(), loadLogin(), generateCart()">
  ...
  <header>
    ...
    <div class="icons">
      ...
      <button class="fas fa-user" id="openLogCont"></button>
    </div>
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div class="shopping-cart">
          ...
          <form action="redirect-checkout.php" method="post">
  ...
  <footer>
    ...
    <div class="box-container">
      ...
      <div class="box">
        <h3>Extra links</h3>
        <a href="signup.html">Mein Account</a>
